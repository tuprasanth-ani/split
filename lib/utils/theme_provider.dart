...
class ThemeProvider extends ChangeNotifier {
  ...
  /// Get card theme
  CardTheme _getCardTheme(ColorScheme colorScheme, Brightness brightness) {
    return CardTheme(
  ...
  /// Get dialog theme
  DialogTheme _getDialogTheme(ColorScheme colorScheme, Brightness brightness) {
    return DialogTheme(
  ...
  BottomSheetTheme _getBottomSheetTheme(ColorScheme colorScheme, Brightness brightness) {
  ...
  /// Get chip theme
  ChipTheme _getChipTheme(ColorScheme colorScheme, Brightness brightness) {
    return ChipTheme(
